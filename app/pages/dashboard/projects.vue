		...
		<div class="flex-1 overflow-y-auto pr-4 no-scrollbar pb-20">
			...
			<div class="space-y-6">
				<div
					...
					:key="index"
					class="group bg-white border border-slate-200 rounded-[2rem] p-6 hover:border-emerald-300 transition-all shadow-sm"
				>
					<button
						...
						<div class="flex-1 space-y-4">
							<div class="flex justify-between items-start">
								<input
									...
									class="text-xl font-black w-full outline-none focus:text-emerald-600 transition-colors"
									@input="portfolio.hasUnsavedChanges = true"
								/>
								<button class="text-slate-300 hover:text-red-500 transition-colors px-2">
			...
			<button
				...
				class="bg-blue-500 text-white px-6 py-3 rounded-2xl font-bold hover:bg-blue-600 transition-all"
			>
